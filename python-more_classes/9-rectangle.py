...
counter that tracks the number of instances created and deleted. Furthermore,
it provides a static method to compare two rectangles based on their area and
a class method to create a square (a rectangle with equal width and height).
"""
...
class Rectangle:
    ...
    Methods:
        ...
        square(cls, size=0):
            ...
            effectively making it a square.
    """
    ...
    def __init__(self, width=0, height=0):
        ...
        Note:
            ...
            The class attribute `print_symbol` defines the symbol used
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        If both have the same area, returns the first rectangle.
    ...
    def square(cls, size=0):
        ...
        This method allows creating a square by passing a single `size`
        argument, which is used for both the width and height.
